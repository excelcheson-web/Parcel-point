...
function TrackPageContent() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      void handleSearch(initialQuery, true)
    }, 0)
    ...
    >
      ...
      <main className="flex flex-col lg:flex-row flex-1 lg:overflow-hidden lg:min-h-0">
        ...
        >
          ...
          >
            ...
            <p className="text-white/40 text-[11px] leading-relaxed mb-3 pl-9">
              Real-time visibility across air, sea, and door-to-door freight.
            </p>
          ...
          {state === 'notfound' && (
            ...
            >
              ...
              <p className="text-white/80 text-sm font-semibold mb-1">No shipment found</p>
              <p className="text-white/40 text-xs leading-relaxed mb-4">
                <span className="text-white/60 font-mono">{searchedValue}</span> matched no active shipments. Confirm the number and try again.
              </p>
              <a
                href={whatsappHref}
                target="_blank"
          ...
          {state === 'error' && (
            <div
              ...
              style={{ background: 'rgba(239,68,68,0.07)', border: '1px solid rgba(239,68,68,0.22)' }}
            >
              <p className="text-red-400 text-sm font-semibold mb-1.5">Lookup failed</p>
              <p className="text-white/45 text-xs mb-3 leading-relaxed">{errorMessage ?? 'An unexpected error occurred.'}</p>
              <button
          ...
          {state === 'empty' && (
            <div className="space-y-3 mt-1">
              ...
              {[
                ...
                { n: '2', t: 'Instant lookup', d: 'We search all active shipments across global carriers in real time.' },
        ...
        <div className="flex-1 relative min-h-72 lg:min-h-0 overflow-hidden">
          ...
          {/* Live location popup — top-left overlay */}
          {state === 'success' && result && (
            <div className="absolute top-4 left-4 pointer-events-none z-20 dashboard-fade-up" style={{ animationDelay: '100ms' }}>
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-widest text-[#A855F7]">Live Position</span>
                </div>
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/45 text-sm">Preparing live tracking…</p>
        </div>
      </div>
    </div>
  )
